...
SHOP_FILE_DATA = os.path.join(
    BASE_PATH,'db','shop_data'
)
...
LOGGING_DIC = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'maxBytes': 1024*5*5,
            'backupCount': 5,
            'filename': os.path.join(BASE_PATH,'log','ATM.log',), # os.path.join(os.path.dirname(os.path.dirname(__file__)),'log','a2.log')
            'encoding': 'utf-8',
            'formatter': 'standard',
